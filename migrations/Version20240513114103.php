 ...
 */
final class Version20240513114103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE building CHANGE slug slug VARCHAR(20) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `building` CHANGE slug slug VARCHAR(50) DEFAULT NULL');
